...
const BoxedTemplate: React.FC<Props> = ({ data, showPhoto }) => {
  ...
  return (
    <div className="font-sans text-gray-800 bg-white p-8 max-w-[800px] mx-auto border-2 border-gray-800 shadow-sm overflow-hidden flex flex-col justify-between" style={{ height: '1131px' }}>
      {/* Header section */}
