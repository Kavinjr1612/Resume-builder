...
const FresherClassicTemplate: React.FC<Props> = ({ data, showPhoto }) => {
  ...
  return (
    <div className="font-serif text-gray-900 bg-white p-10 max-w-[800px] mx-auto border border-gray-200 shadow-sm overflow-hidden flex flex-col justify-between" style={{ height: '1131px' }}>
      {/* Header */}
