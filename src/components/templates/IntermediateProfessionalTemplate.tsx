...
const IntermediateProfessionalTemplate: React.FC<Props> = ({ data, showPhoto }) => {
  ...
  return (
    <div className="font-sans text-gray-800 bg-white p-10 max-w-[800px] mx-auto border border-gray-200 shadow-sm overflow-hidden flex flex-col justify-between" style={{ height: '1131px' }}>
      {/* Header */}
