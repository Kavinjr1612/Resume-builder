...
const ExperiencedExecutiveTemplate: React.FC<Props> = ({ data, showPhoto }) => {
  ...
  return (
    <div className="font-serif text-gray-900 bg-white p-12 max-w-[800px] mx-auto border border-gray-300 shadow-md relative overflow-hidden flex flex-col justify-between" style={{ height: '1131px' }}>
